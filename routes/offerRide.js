...
const { getOfferedRideById } = require('../controllers/offerRide/getRideById');
...
router.get('/ridesbyid/:userId', getOfferedRideById);  // Route to get a specific ride offer by ID
